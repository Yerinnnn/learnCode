					...
					<div class="col-8 col-12-medium imp-medium">
						<div id="content">
							...
							<article>
								...
								<div class="bbs-list-item" style="border-top: 0.5px solid rgb(156, 156, 156)">
									<div class="item-main">
										<div class="item-title">안녕하세요 가입 인사 드립니다</div>
										<span class="item-username"><i>신예린</i></span>
										<span class="item-date">2019/04/05</span>
									</div>
									<div class="item-sub">
							...
							<a  href="write.jsp"><input type="submit" class="submit-button" value="Write" style="font-size: 1.2em;float: right;"></a>
