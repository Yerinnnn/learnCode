							...
							<section>
								<div class="filter">
									...
									<ul>
										...
										<li><a class="filter-item">취업/진로 게시판<span class="count">253</span></a></li>
										<li><a class="filter-item">QnA<span class="count">253</span></a></li>
										<li><a></a></li>
									</ul>
								</div>
								<footer>
									<a href="#" class="button icon fa-info-circle" style="font-size: 1.3em">Find out
										more</a>
								</footer>
							</section>
							...
							<article>
								<div class="editer-border">
									<form method="post" action="writeAction.jsp">
										<ul class="subject">
											<li>
												<label class="item" for="bbsCategory">게시판</label>
												<div>
											...
											<li>
												<label class="item" for="bbsTitle">제목</label>
												<div>
													<input type="text" name="bbsTitle" style="width: 30em" maxlength="50" placeholder="게시글 제목을 입력하세요">
												</div>
											</li>
											<li>
												<textarea name="bbsContent" style="width: 50em;min-width:42em;max-width: 42em;" rows="10" maxlength="2048"></textarea>
											</li>
										</ul>
										<input type="submit" class="submit-button" value="Submit" style="font-size: 1.2em;float: right;">
									</form>
